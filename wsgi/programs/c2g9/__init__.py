...
<a href="drawtriangle">c2g9 drawtriangle 繪圖</a><br />
<a href="drawtriangle2">c2g9 drawtriangle2 繪圖</a><br />
'''
        return outstring
    ...
    @cherrypy.expose
    def drawtriangle(self, *args, **kwargs):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    def drawtriangle2(self, *args, **kwargs):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
